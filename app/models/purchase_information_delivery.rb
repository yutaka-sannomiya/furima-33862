class PurchaseInformationDelivery
  ...
  attr_accessor :user_id, :item_id, :postal_code, :shipping_area_id, :municipalities, :address, :building, :tel, :purchase_information, :token
  ...
  with_options presence: true do
    ...
    validates :address
    validates :tel, numericality: {with: /\A[0-9]{11}\z/, message: 'Half-width number'}
